...
import drlugha.translator.DTOs.stats.TotalSentencesDto;
import drlugha.translator.DTOs.stats.TotalTranslatedSentencesDto;
...
public interface BatchDetailsRepository extends JpaRepository<BatchDetailsEntity, Long> {
    ...
    SentenceEntity findSentenceByAudioUrl(@Param("batchDetailsId") Long batchDetailsId, @Param("audioUrl") String audioUrl);


    @Query("SELECT new SentenceEntity(" +
            ...
            "JOIN SentenceEntity s ON s.sentenceId = t.sentenceId " +
